---1. Backup all objects
---2. Delete Merrick.Dim_Daily_Well_Production and Merrick.Fact_Daily_Well_Production along with everything else.
---3. Enable FACT rules
---4. Run
---4. Perform analysis on Backups
...
DELETE FROM Merrick.Dim_Daily_Well_Production
DELETE FROM Merrick.Fact_Daily_Well_Production

DELETE FROM          [Aries].[Fact_Well_Header] 
DELETE FROM       [Wellview].[Fact_Well_Header] 
DELETE FROM        [Merrick].[Fact_Well_Header] 
DELETE FROM          [Petra].[Fact_Well_Header] 
DELETE FROM        [Enertia].[Fact_Well_Header] 
DELETE FROM      [SigmaFlow].[Fact_Well_Header] 
DELETE FROM   [FracSchedule].[Fact_Well_Header] 
DELETE FROM [Aries_Planning].[Fact_Well_Header] 
...
DELETE FROM Master.Sat_Well_Header_Alias_Well_Name
...
---SELECT * FROM          [Aries].[Fact_Well_Header] 
---SELECT * FROM       [Wellview].[Fact_Well_Header] 
---SELECT * FROM        [Merrick].[Fact_Well_Header] 
---SELECT * FROM          [Petra].[Fact_Well_Header] 
---SELECT * FROM        [Enertia].[Fact_Well_Header] 
---SELECT * FROM      [SigmaFlow].[Fact_Well_Header] 
---SELECT * FROM   [FracSchedule].[Fact_Well_Header] 
---SELECT * FROM [Aries_Planning].[Fact_Well_Header] 
