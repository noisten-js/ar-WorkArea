...
/****** Object:  StoredProcedure [Etl].[Process_Merrick]    Script Date: 11/15/2024 11:16:32 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    DECLARE @Process_Name                   NVARCHAR(256) = NULL
    DECLARE @AllocationHistoryDaysToProcess INT           = -1
...
---Run all initially
		SET @AllocationHistoryDaysToProcess = -1
